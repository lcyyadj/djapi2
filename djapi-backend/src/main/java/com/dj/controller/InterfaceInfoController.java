...
import com.dj.djapiclientsdk.client.DjApiClient;
import com.dj.djapiclientsdk.model.request.CurrencyRequest;
import com.dj.djapiclientsdk.model.response.ResultResponse;
import com.dj.djapiclientsdk.service.ApiService;
import com.dj.exception.BusinessException;
import com.dj.model.dto.interfaceInfo.InterfaceInfoAddRequest;
import com.dj.model.dto.interfaceInfo.InterfaceInfoQueryRequest;
import com.dj.model.dto.interfaceInfo.InterfaceInfoUpdateRequest;
import com.dj.model.dto.interfaceInfo.InvokeRequest;
import com.dj.model.enums.InterfaceInfoStatusEnum;
...
import com.djapicommon.model.emums.InterfaceStatusEnum;
...
public class InterfaceInfoController {
    ...
    @Resource
    private DjApiClient djApiClient;
    @Resource
    ...
    public BaseResponse<Object> invokeInterface(@RequestBody InvokeRequest invokeRequest, HttpServletRequest request) {
        ...
        // 构建请求参数
        List<InvokeRequest.Field> fieldList=null;
        try{
            fieldList= JSONUtil.toList(invokeRequest.getUserRequestParams(), InvokeRequest.Field.class);
        }catch (Exception e){
        ...
        try {
            DjApiClient djApiClient = new DjApiClient(accessKey, secretKey);
            ...
            ResultResponse response = apiService.request(djApiClient, currencyRequest);
